...
class MakeXMLSM:
    def __init__(self, st_date_time):
        ...
        with open('config/sm_config.json', 'rb') as config_sm:
            var_config_sm = json.load(config_sm)
            config_sm.close()

        self.prgm_lang = var_config_sm["pgm_language"]
        self.src_dir = var_config_sm["sel_dir"]
    ...
    def gen_sm_report(self):
        os.system("sourcemonitor.exe /c \"config/sourc_mn.xml\"")
        pass
